...
Ext.define('Ext.ux.form.field.OperatorButton', {
    ...
    init : function (textField) {
        ...
        me.operator = (Ext.Array.contains(me.operators, me.operator) ?
            me.operator : me.operators[0]);
        ...
        if (!textField.rendered) {
            textField.on('afterrender', me.onFieldRender, me, {
                single : true
            });
        } else {
            me.onFieldRender();
    ...
    repositionOperatorButton : function () {
        ...
        if (!btn)
            return;
        btn.alignTo(this.textField.bodyEl, 'tl-tl', [
            2,
            4
        ]);
    }
